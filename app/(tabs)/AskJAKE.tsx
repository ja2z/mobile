...
type AskJAKERouteProp = RouteProp<RootStackParamList, 'AskJAKE'>;
type AskJAKEScreenNavigationProp = StackNavigationProp<RootStackParamList, 'AskJAKE'>;
...
export default function AskJAKE() {
  ...
  const navigation = useNavigation<AskJAKEScreenNavigationProp>();
