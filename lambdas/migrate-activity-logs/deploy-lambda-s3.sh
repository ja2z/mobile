...
# Deploy Migration Lambda via S3 (faster for large files)
...
S3_KEY="migrate-activity-logs/${FUNCTION_NAME}-$(date +%Y%m%d-%H%M%S).zip"
ZIP_FILE="migrate-activity-logs.zip"
